...
std::vector<cv::Mat> D435::Get3_depth(cv::Mat mean_depth_average,
  ...
  for (int i = 0; i < three_map_down.size(); i++) {
    ...
    thresholding2gray(three_map_up[i],mean_depth_average(ROI_UP),threshold_data,0,nums-1,ROI_UP,result_image);
    thresholding2gray(three_map_down[i],mean_depth_average(ROI_DOWN),threshold_data,k,nums-1,ROI_DOWN,result_image);
